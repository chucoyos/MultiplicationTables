...
public class Times4Activity extends AppCompatActivity {
    ...
    public void newQuestion(){
        ...
        for (int i = 0; i < 4; i++){
            if (i == locationOfCorrectAnswer){
                answers.add(4 * multiplicador);
            } else {
                int wrongAnswer = random.nextInt(41);

                while (wrongAnswer == 4 * multiplicador){
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_times4);
